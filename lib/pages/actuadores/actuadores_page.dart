  ...
  double _getYAxisMax() {
    switch (selectedChart) {
      case '/actuadores/Ajuste combustible corto':
        return 30;
      case '/actuadores/Avance encendido':
        return 15;
      case '/actuadores/Carga motor':
        return 100;
      case '/actuadores/Flujo aire masivo':
        return 100;
      case '/actuadores/Presion barometrica':
        return 20;
      case '/actuadores/Presion colector admision':
        return 10;
      case '/actuadores/Purga de sistema evaporacion':
        return 10;
      case '/actuadores/RPM':
        return 8000;
      case '/actuadores/Valvula admision':
        return 100;
      case '/actuadores/Velocidad':
        return 200;
      default:
        return 0.0;
    }
            ...
            child: Container(
              ...
              child: DropdownButton<String>(
                ...
                items: <String>[
                  ...
                  '/actuadores/Avance encendido',
                  '/actuadores/Carga motor',
                  '/actuadores/Flujo aire masivo',
                  '/actuadores/Presion barometrica',
                  '/actuadores/Presion colector admision',
                  '/actuadores/Purga de sistema evaporacion',
                  '/actuadores/RPM',
                  '/actuadores/Valvula admision',
                  '/actuadores/Velocidad',
                ]
